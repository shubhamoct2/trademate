                                    ...
                                    <table class="display data-table history-table">
                                        ...
                                        <tbody>                            
                                            ...
                                            <tr class="{{ isset($summary_item['class']) ? $summary_item['class'] : '' }}">
                                                ...
                                                <td>{{ isset($summary_item['monday']) ? '$ ' . $summary_item['monday'] : '' }}</td>
                                                <td>{{ isset($summary_item['tuesday']) ? '$ ' . $summary_item['tuesday'] : '' }}</td>
                                                <td>{{ isset($summary_item['wednesday']) ? '$ ' . $summary_item['wednesday'] : '' }}</td>
                                                <td>{{ isset($summary_item['thursday']) ? '$ ' . $summary_item['thursday'] : '' }}</td>
                                                <td>{{ isset($summary_item['friday']) ? '$ ' . $summary_item['friday'] : '' }}</td>
                                                <td>{{ isset($summary_item['saturday']) ? '$ ' . $summary_item['saturday'] : '' }}</td>
                                                <td>{{ isset($summary_item['sunday']) ? '$ ' . $summary_item['sunday'] : '' }}</td>
                                                <td>{{ isset($summary_item['week']) ? '$ ' . $summary_item['week'] : '' }}</td>
                                            </tr>
                                            @endforeach                                                         
                                        </tbody>
                                    </table>
