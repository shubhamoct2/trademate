<div class="side-nav ">
    <div class="side-wallet-box default-wallet mb-0">
        <div class="user-balance-card">
            ...
            <div class="wallet-info">
                <div class="wallet-id"><i icon-name="receipt"></i>{{ __('Commission Wallet') }}</div>
                <div class="balance">{{ setting('currency_symbol','global').$user->commission_balance }}</div>
            </div>
        </div>
        <div class="actions">
        ...
        <ul class="side-nav-menu">
            ...
            <li class="side-nav-item {{ isActive('user.transactions*') }}">
                <a href="{{ route('user.transactions') }}"><i
                        class="anticon anticon-inbox"></i><span>{{ __('Transaction History') }}</span></a>
            </li>
            ...
            <li class="side-nav-item {{ isActive('user.wallet-exchange') }}">
                <a href="{{ route('user.wallet-exchange') }}"><i
                        class="anticon anticon-transaction"></i><span>{{ __('Internal Transfer') }}</span></a>
            </li>
            ...
            <li class="side-nav-item @if( Route::currentRouteName() != 'user.send-money.log') {{ isActive('user.send-money*') }} @endif">
                <a href="{{ route('user.send-money.view') }}"><i
                        class="anticon anticon-export"></i><span>{{ __('Profit Transfer') }}</span></a>
            </li>
